    ...
    return ( 
       <div className='container'>
        ...
        <p>Known as the most popular national reserve of Kenya, the Amboseli National Park welcomes you to take a walk amidst the free-ranging African elephants. Crowned by the highest peak of Africa, Mount Kilimanjaro, this National Reserve occupies 39,206 hectares of land and spreads across the Kenya-Tanzania border. The name Amboseli is derived from a Maasai word that means ‘Salty dust’. The parched condition of this national park goes perfectly with its name.
           ...
           The research camp is established at the heart of the park for the research of African elephants. It requires prior permission to enter the research camp.             Normatior(Observation hill)-
           ...
           Free goodies to make your safari more exciting!</p>
        ...
        <p>Lake Naivasha derives its name from the Maasai word for ‘rough water’ due to the sudden storms that are known to arise in the area. Easily accessible from Nairobi, the lake is a refreshing day trip or weekend break from Kenya’s busy capital.
        ...
        <p>Welcome to Kenya’s most accessible yet incongruous safari experience. Set on the city’s southern outskirts, Nairobi National Park (at 117 sq km, one of Africa’s smallest) has abundant wildlife that can, in places, be viewed against a backdrop of city skyscrapers and planes coming in to land – it's one of the only national parks on earth bordering a capital city. Remarkably, the animals seem utterly unperturbed by it all.
           ...
           Unless you already have your own vehicle, the cheapest way to see the park is on the shuttle, a big Kenya Wildlife Service (KWS) bus that leaves the main gate at 2pm on Sunday for a 2½-hour tour. You need to book in person at the main gate by 1.30pm, but do call ahead if you want to do the tour, as times can change. </p>

        <h1>Tsavo National Park</h1>
        <img id="img1" src="https://www.tsavonationalparkkenya.com/wp-content/uploads/2020/03/Tsavo-national-park-animals-750x450.jpg" alt="" />
        <p>Tsavo is made up of two separate parks, Tsavo East National Park and Tsavo West National Park. Located in Coast Province of Kenya in between Nairobi City and Mombasa. 
        ...
        <img id="img2" src="https://lh3.googleusercontent.com/p/AF1QipPPH1m_OlFz61ToftUOfy3dWSJ8MwNK5oyq9g_K=s680-w680-h510" alt="" />
        <p>Hell’s Gate National Park is located in the southern part of Kenya just northwest of Nairobi.    The national park encompasses an area of 26.35 square miles (68.25 sq km).  Hell’s Gate borders up to the sister Lake Nakuru National Park.
        ...
        <img id="img2" src="https://www.kenyasafari.com/images/the-ark-elephants-aberdare-590x390.jpg" alt="" />
        <p>The Aberdare National Park in the central highlands of Kenya retains an air of mystery - you can only imagine what undiscovered creatures still lurk here, such as rare Black Leopards.
            ...
            Serval and Leopard also occur some of which have a rare black coat. There are many species of primates, including Black and White Colobus and Sykes and Vervet Monkey's.  </p>
       
        <h1>Mount Kenya National Park</h1>
        <img id="img1" src="https://www.naturaltoursandsafaris.com/wp-content/webp-express/webp-images/uploads/2018/03/mount-kenya-national-park.jpg.webp" alt="" />
        <p>It’s the second highest mountain in Africa. It borders the equator, yet it supports 12 glaciers, plus pristine lakes, tarns and dense alpine forest. This is Mt. Kenya National Park – a land and a world away from all the other national parks.
           The climbing is excellent, as is the camping. And when the mists burn off, the vistas are magnificent. Here, in this UNESCO World Heritage Site you can begin your trek in tropical forest, spotting buffalo and elephant. You’ll then ascend to bamboo forest perhaps spotting Colubus and other monkeys. You can also find antelope and giant forest hogs in this dense wooded terrain. Your trek continues into alpine moorlands which will present bizarre flora like the towering giant lobelia.
           ...
           Beginning your climb at the mountain’s tropical base, you’ll be welcomed by the park’s prolific birdlife. As you trek up through the forests and moors, watch for sunbirds, eagles and other avian life in this towering park. </p>
