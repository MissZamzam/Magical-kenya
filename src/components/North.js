...
const North = () => {
  return (
    ...
    <div className="container__body">
        ...
        <p>
          Northern Kenya is a largely unexplored expanse of wild beauty rich in
          colour and experiences. Every day, the sun seems to be smiling down on
          this part of the country with sights, sounds and sceneries that are of
          unmatched brilliance.The reputation of Northern Kenya has been
          transformed in the past few years by a community-driven determination
          to promote and maintain peace, protect the region’s unique wildlife
          and habitats, and preserve diverse and historic cultures. This area is
          one of Africa’s best-kept secrets and Saruni has two properties here –
        ...
        <img
          id="img1"
          src="https://i0.wp.com/saruni.com/wp-content/uploads/2018/07/NK-7.jpg?resize=1024%2C683&ssl=1"
          alt=""
        />
        <p>
        ...
        <h1>Sibiloi National Park</h1>
        <img
          id="img2"
          src="https://i0.wp.com/saruni.com/wp-content/uploads/2022/06/Northen-Kenya2.jpg?w=800&ssl=1"
          alt=""
        />
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit.Laudantium
