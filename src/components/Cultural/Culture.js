...
const Culture = () => {
    ...
    <div>
        ...
        <img id="img2" src="https://i.pinimg.com/564x/4e/47/4e/4e474e30abed551d04062acf64beae29.jpg" alt="" />
        <p>From the bustling city centre of Nairobi to the port and beaches of Mombasa, Kenyan cuisine reflects the diversity of its people and its various cultural influences stemming back to the Indian Ocean trade. Whether it’s traditional nyama choma (meat roasted over charcoal) served with ugali (maize-meal cake), seafood with exotic spices, or hot Indian curries, the local cuisine is varied and full of flavour. Here are 10 great Kenyan restaurants, each reflecting a part of the country’s rich food and culinary culture.</p>
        <p>Serving a superb blend of Asian, Middle Eastern, French and Italian cuisine, the Talisman Restaurant is a favorite dining spot in downtown Nairobi. The restaurant’s chefs whip up a wonderful selection of fine dishes from scratch using freshly sourced fish from Lamu. Offering 20 different international wines by the glass and a large malt whiskey selection, Talisman also crafts some decadent cocktails. Try the Double Dawas or the award-winning Super Striker for a pleasant surprise. The Talisman features carved wooden pillars, gorgeous tapestries and striking African art, as well as a charming garden full of fig trees and bombax, providing a stylish yet relaxed setting. With live entertainment on selected nights, a visit to the Talisman promises a truly memorable dining experience.</p>
        <img id="img1" src="https://i.pinimg.com/564x/90/85/24/908524b74b214f138a28fd23d65ba69b.jpg" alt="" />
        <img id="img2" src="https://i.pinimg.com/564x/e9/b2/b1/e9b2b1141f589093426733da195d8d3b.jpg" alt="" />
        <p>True to its name, it is of no surprise that meat lovers flock to The Carnivore, an open-air meat speciality restaurant situated just outside Nairobi’s busy city centre. From beef, chicken and ostrich on one end to more exotic dishes of crocodile and camel, the meat is grill-roasted and carved at the table. The buffet option includes an array of tantalising house sauces, soups and desserts. The Carnivore also houses an informal à la carte restaurant during the day that turns into a popular nightclub called Simba Saloon. Set out in a lovely tropical garden with typically African decor, the Carnivore promises an all-you-can-eat feast, matched with impeccable service with a smile, however, at a price. Coupled with traditional dance performances and live music, the Carnivore is simply an extremely seductive option.</p>
        <p>The Open House is one of the best and beloved Indian restaurants in Nairobi. Catering for mild palates to experienced chilli fanatics, the restaurant dishes are authentic, full of distinct flavours and aromatic spices, transporting its diners across the ocean to the heart of India. Dishes include tandoori chicken, mutton biryani, fish tikka masala and an extensive number of traditional vegetarian dishes, all served with aromatic homemade Indian bread. After a spicy meal, try the house special dessert of kulfi badam pista, a heavenly frozen delight made from milk thickened with khoya, chopped almonds and pistachios. Apart from a series of colourful paintings decorating the walls, the Indian-themed décor is simple and tidy, keeping the restaurant’s full focus on its splendid food offering.</p>
        ...
        <ul>
          ...
          <li>Eid</li>
          <a href="https://www.lamuholiday.com/swahili-culture/swahili-festivals.html">Read more on Lamu Cultural Festivals</a>
        </ul>
